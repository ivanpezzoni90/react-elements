  ...
  return function RadioEditorFn() {
    ...
    return <_react.Fragment>
                <_commons.ElementContainer>
                    <_Radio.default {...radioProps} type={radioProps.type} // Workaround to change number of options using value prop
        options={radioProps.value ? generateOptions(radioProps.value) : defaultOptions} value={radioProps.value} />
                </_commons.ElementContainer>
                <_EditorBuilder.default json={getEditor(radioProps)} onChange={onChangeProp} />
            </_react.Fragment>;
  };
}